...
```bash
curl -s -X PUT https://localhost/demo-basic/api/TableName/main-counter \
...
```bash
curl -s https://localhost/demo-basic/api/TableName/main-counter
```
...
```bash
curl -s https://localhost/demo-basic/api/greeting
```
...
```bash
curl -s "https://localhost/demo-basic/api/TableName?limit=10"
```
...
curl -s --max-time 30 "https://localhost/demo-basic/api/TableName?stream=sse"
```
